    ...
    public static ModuleConfig[] moduleConfigs =
            switch (Constants.getRobot()) {
                case COMPBOT -> new ModuleConfig[] {
                    new ModuleConfig(1, 2, 9, Rotation2d.fromRotations(-0.383).plus(Rotation2d.fromDegrees(180)), true),
                    new ModuleConfig(
                            3, 4, 10, Rotation2d.fromRotations(-0.251).plus(Rotation2d.fromDegrees(180)), true),
                    new ModuleConfig(
                            5, 6, 11, Rotation2d.fromRotations(-0.057).plus(Rotation2d.fromDegrees(180)), true),
                    new ModuleConfig(7, 8, 12, Rotation2d.fromRotations(-0.470).plus(Rotation2d.fromDegrees(180)), true)
                };
                case SIMBOT -> {
    ...
    public static final ModuleConstants moduleConstants =
            switch (Constants.getRobot()) {
                case COMPBOT -> new ModuleConstants(
                        0.1, 0.13, 0.1, 0.0, 10.0, 0.0, Mk4iReductions.L2.reduction, Mk4iReductions.TURN.reduction);
                case SIMBOT -> new ModuleConstants(
                        0.014, 0.134, 0.1, 0.0, 10.0, 0.0, Mk4iReductions.L2.reduction, Mk4iReductions.TURN.reduction);
            };
