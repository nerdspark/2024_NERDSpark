...
public class RobotContainer { // implements RobotConstants{
    ...
    // private final CommandSwerveDrivetrain drivetrain = RobotIdentity.getIdentity() == RobotIdentity.SMIDGE_2024  ?
    // TunerConstantsSmidge.DriveTrain : TunerConstantsSmudge.DriveTrain;
    // SmartDashboard.putBool("robotBool", (RobotIdentity.getIdentity() == RobotIdentity.SMIDGE_2024));
    ...
    public RobotContainer() {
        System.out.println("robotIdentity" + (RobotIdentity.getIdentity() != RobotIdentity.SMIDGE_2024));
        ...
        //         scheduleArmCommands();
        // }
        SmartDashboard.putBoolean("robotBool", (RobotIdentity.getIdentity() != RobotIdentity.SMIDGE_2024));
        if (RobotIdentity.getIdentity() != RobotIdentity.SMIDGE_2024) {
            SmartDashboard.putString("robotID", "Smudge");
        } else {
            SmartDashboard.putString("robotID", "Smidge");
        }

        // new Trigger(() -> RobotIdentity.getIdentity() != RobotIdentity.SMIDGE_2024)
        //         .whileTrue(new RunCommand(() -> Smartdashboard.putstoString().out.println("Smudge")))
        //         .whileFalse(new RunCommand(() -> System.out.println("Smidge")));
    ...
    private void configureDefaultCommands() {
        ...
        //                         .withRotationalRate(
        //                                 calculateAutoTurn(() -> 0.0)) // Drive counterclockwise with negative X
        // (left)
        //                 ));
    ...
    //         NamedCommands.registerCommand("fourBarToHome", new FourBarCommand(fourBar, () ->
    ...
    //         NamedCommands.registerCommand("fourBarToRCR2", new FourBarCommand(fourBar, () ->
    // AutoConstants.redCenterRing2));
    //         NamedCommands.registerCommand("fourBarToRCR3", new FourBarCommand(fourBar, () ->
    // AutoConstants.redCenterRing3));
    //         NamedCommands.registerCommand("fourBarToRCR4", new FourBarCommand(fourBar, () ->
    // AutoConstants.redCenterRing4));
    ...
    //         NamedCommands.registerCommand("fourBarToWSR1", new FourBarCommand(fourBar, () ->
    // AutoConstants.weirdSideRing1));
    //         NamedCommands.registerCommand("fourBarToWSR2", new FourBarCommand(fourBar, () ->
    // AutoConstants.weirdSideRing2));
    //         NamedCommands.registerCommand("fourBarToWSR3", new FourBarCommand(fourBar, () ->
    // AutoConstants.weirdSideRing3));
    //         NamedCommands.registerCommand("fourBarToWSR4", new FourBarCommand(fourBar, () ->
    ...
    //                                                 -JoystickMap.JoystickPowerCalculate(driver.getRightY()) *
    // MaxSpeed))
