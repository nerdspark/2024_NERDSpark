...
public class RobotContainer {
    ...
    private PIDController gyroPid = new PIDController(DrivetrainConstants.gyroP, DrivetrainConstants.gyroI, DrivetrainConstants.gyroD);
    ...
    private void configureNamedCommands() {
        ...
        NamedCommands.registerCommand("fourBarToIntake", new FourBarCommand(fourBar, () -> FourBarConstants.fourBarOut));
        ...
        NamedCommands.registerCommand("fourBarToBCR2", new FourBarCommand(fourBar, () -> AutoConstants.blueCenterRing2));
        NamedCommands.registerCommand("fourBarToBCR3", new FourBarCommand(fourBar, () -> AutoConstants.blueCenterRing3));
        NamedCommands.registerCommand("fourBarToBCR4", new FourBarCommand(fourBar, () -> AutoConstants.blueCenterRing4));
        ...
        NamedCommands.registerCommand("RfourBarToWSR1", new FourBarCommand(fourBar, () -> AutoConstants.red_weirdSideRing1));
        NamedCommands.registerCommand("RfourBarToWSR2", new FourBarCommand(fourBar, () -> AutoConstants.red_weirdSideRing2));
        NamedCommands.registerCommand("RfourBarToWSR3", new FourBarCommand(fourBar, () -> AutoConstants.red_weirdSideRing3));
        NamedCommands.registerCommand("RfourBarToWSR4", new FourBarCommand(fourBar, () -> AutoConstants.red_weirdSideRing4));

        NamedCommands.registerCommand("forcedIntake", new IntakeCommand(intake, () -> 1.0, IntakeCommand.IntakeMode.FORCEINTAKE));

        NamedCommands.registerCommand("forcedIntakeShoot", new IntakeCommand(intake, () -> 1.0, IntakeCommand.IntakeMode.FORCEINTAKESHOOT));

        NamedCommands.registerCommand("forcedIntakeZero", new IntakeCommand(intake, () -> 0.0, IntakeCommand.IntakeMode.FORCEINTAKE));

        NamedCommands.registerCommand("onlySoftIntake", new IntakeCommand(intake, () -> 0.6, IntakeCommand.IntakeMode.SOFTINTAKE));
