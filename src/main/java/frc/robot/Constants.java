...
public final class Constants {
    ...
    public final class FixedShotConstants {
        ...
        public static final double RPMLong = 5650.0;
    ...
    public final class AutoConstants {
        ...
        public static final double blueAmpSide4 = 1.99; // 1.9
        ...
        public static final double redRECenterNote6 = 1.88; // 1.80
    ...
    public static class ShooterConstants {
        ...
        static {
            ...
            shooterMap.put(7.5, 5400.0);
            shooterMap.put(7.0, 5300.0);
